...
**Stats to include:**
- Count modified files: `jj log -r 'feat(XX-XX)::feat(YY-YY)' --stat | tail -1` or use `jj diff --stat -r 'feat(XX-XX)::feat(YY-YY)'`
...
- Use JJ change IDs or commit IDs as appropriate
</guidelines>
