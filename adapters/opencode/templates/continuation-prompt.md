...
**OpenCode-specific:** Uses `~/.config/opencode/get-shit-done/` paths.
...
**Verify before continuing:** Check that these commits exist with `jj log --no-graph -T 'commit_id.short() " " description.first_line()' -r @- -n 5`
</completed_tasks>
