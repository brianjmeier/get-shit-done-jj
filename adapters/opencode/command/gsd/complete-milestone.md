...
Output: Milestone archived, roadmap reorganized, JJ tagged.
</objective>
...
6. **Commit and tag:**
   ...
   - Tag: Use JJ bookmark pattern or `jj git push --bookmark v{{version}}` for GitHub
   - Ask about pushing bookmark
...
- JJ bookmark/tag v{{version}} created
- Commit successful
